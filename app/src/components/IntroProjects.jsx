...
export default function IntroProjects() {
    ...
    return <section className="w-10/12 mt-20 relative z-10 text-center sm:text-left text-md sm:text-lg flex flex-col sm:flex-row justify-around xl:justify-center pointer-events-none gap-10 xl:mb-44">
